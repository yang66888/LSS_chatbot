...
if __name__ == '__main__':
    domain = TemplateDomain.load("chatbot_domain.yml")
    stories = StoryFileReader.read_from_file("/Users/zhengyang/Desktop/working/storage_chatbot/data/stories.md", domain)
